...
public class ViewPromotionController extends HttpServlet {
    ...
    private static final String SUCCESS = "US_PromotionPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PromotionDTO> promotionList = dao.selectAllPromotions();
            request.setAttribute("PROMOTION_LIST", promotionList);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at ViewPromotionController: " + e.toString());
        } finally {
