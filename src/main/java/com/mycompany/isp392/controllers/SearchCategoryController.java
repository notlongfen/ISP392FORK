...
public class SearchCategoryController extends HttpServlet {
    ...
    private static final String SUCCESS = "AD_CategoriesList.jsp";
...
//            }
            ...
            if (searchText == null || searchText.isEmpty()) {
                ...
                listCategories = categoryDAO.searchCategories(searchText);
            }
            
            if (listCategories != null && !listCategories.isEmpty()) {
                request.setAttribute("CATEGORY_LIST", listCategories);
                request.setAttribute("MESSAGE", "CATEGORIES FOUND !");
                url = SUCCESS;
            } else {
                request.setAttribute("MESSAGE", "NO CATEGORY FOUND !");
            }
