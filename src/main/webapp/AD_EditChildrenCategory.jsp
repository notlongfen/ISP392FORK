...
<html>
    <head>
        ...
        <title>Edit Category Children</title>
        <style>
            .form-container {
                max-width: 800px;
                margin: 50px auto;
                            ...
                            <form style="margin-top: 50px;">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="productName">Edit Category Children Name</label>
                                        <input type="text" class="form-control" id="productName" style="margin-top: 10px;" value="shoes">
                                    </div>
