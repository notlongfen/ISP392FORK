...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .product_image1 {
                width: 270px;  /* ??t kích th??c c? ??nh cho ph?n t? cha */
                height: 250px; /* ??t kích th??c c? ??nh cho ph?n t? cha */
                overflow: hidden; /* ?n ph?n nào c?a hình ?nh v??t quá kích th??c khung ch?a */
            }
            .product_image1 img {
                width: 100%;
                height: 100%;
                object-fit: cover; /* B?n có th? th? 'cover' ho?c 'contain' tùy theo mong mu?n */
            }
        </style>
    </head>
    <body>
