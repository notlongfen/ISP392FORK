                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="mb-0 font-weight-bold text-gray mb-2" style="font-size: 20px;">Today: $<c:out value="${totalIncomeToday}" /></div>
                                            <div class="mb-0 font-weight-bold text-gray" style="font-size: 20px;">Yesterday: $<c:out value="${totalIncomeYesterday}" /></div>                            
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="mb-0 font-weight-bold text-gray mb-2" style="font-size: 20px;">Today: <c:out value="${numberOfOrdersToday}" /></div>
                                            <div class="mb-0 font-weight-bold text-gray" style="font-size: 20px;">Yesterday: <c:out value="${numberOfOrdersYesterday}" /></div>                            
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="mb-3">
                                        <c:forEach var="product" items="${top5Products}">
                                            <div class="product">
                                                ...
                                                <span style="font-size: 13px">${product.numberOfPurchase} purchases</span>
                                            </div>
                                        </c:forEach>
                                    </div>
                                </div>
