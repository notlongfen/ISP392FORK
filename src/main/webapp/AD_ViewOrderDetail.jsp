        ...
        %>
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-900"><b>Order Detail</b></h1>
                        </div>
                                    ...
                                    <table class="table align-items-center table-flush">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th class="text-left">Promotion ID</th>
                                        ...
                                        <tbody id="tableBody">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><%= order.getPromotionID() %></td>
...
<!--                        <form action="MainController">
                            <div class="d-flex justify-content-end" >
                                <button type="submit" class="btn btn-primary btn-danger" name="action" value="Back_To_OrderList">Back</button>
                            </div>
                        </form>-->
                    </div>
                    <!--Row-->
